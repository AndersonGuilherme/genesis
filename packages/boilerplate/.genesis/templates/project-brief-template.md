...
> Documento de uma página para apresentar o projeto a pessoas novas. Resumo executivo do que existe nos demais docs.
...
|-------|-------|
| Nome | _(...)_ |
| Tagline | _(uma frase)_ |
| Categoria | SaaS / marketplace / B2B / B2C / ... |
| Estágio | ideia / discovery / spec / MVP / pós-MVP |
| Data | _(YYYY-MM-DD)_ |
| Última atualização | _(YYYY-MM-DD)_ |

## Resumo (3 linhas)

_(O que é o projeto, para quem, e qual o diferencial.)_
...
| Fonte de receita | Tipo | Quem paga | Faixa |
|------------------|------|-----------|-------|
