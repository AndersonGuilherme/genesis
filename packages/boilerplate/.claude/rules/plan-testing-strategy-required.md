---
name: plan-testing-strategy-required
description: Todo módulo precisa de estratégia de teste documentada antes do código. Gate de PR reforça.
phase: planning
---

# Rule: plan-testing-strategy-required
