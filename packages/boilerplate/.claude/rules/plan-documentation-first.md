---
name: plan-documentation-first
description: Toda decisão importante atualiza doc antes ou junto com a mudança. Doc é memória externa do projeto.
phase: planning
---

# Rule: plan-documentation-first
