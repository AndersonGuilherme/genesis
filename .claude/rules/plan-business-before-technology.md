---
name: plan-business-before-technology
description: Não escolher stack ou padrão técnico antes de entender problema, usuário, valor e modelo de negócio.
phase: planning
---

# Rule: plan-business-before-technology
