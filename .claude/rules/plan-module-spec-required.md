---
name: plan-module-spec-required
description: Nenhum módulo é implementado sem spec completa em docs/specs/<modulo>/. Spec é o contrato.
phase: planning
---

# Rule: plan-module-spec-required
