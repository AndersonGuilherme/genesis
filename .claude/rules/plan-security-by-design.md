---
name: plan-security-by-design
description: Segurança pensada antes do código, em cada decisão. LGPD e auth não se resolvem com patch.
phase: planning
---

# Rule: plan-security-by-design
