...
| Skill anterior | [`discover-business`](02-discover-business.md) |
| Skill seguinte | [`define-product`](03-define-product.md) |
...
- Após [`discover-business`](02-discover-business.md) ter mapeado fontes de receita iniciais como hipóteses.
- Antes de [`define-product`](03-define-product.md) — porque o pricing influencia o que entra no MVP (ex.: feature gratuita ou só Pro).
...
Decisão importante. Crie ADR via [`create-adr`](11-create-adr.md):
...
Marca conclusão e sugere [`define-product`](03-define-product.md).
...
➡️ **[`define-product`](03-define-product.md)** — definir MVP com pricing já em mente.
