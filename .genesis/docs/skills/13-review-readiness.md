...
| Skill anterior | [`create-implementation-plan`](12-create-implementation-plan.md) |
| Skill seguinte | [`start-development`](14-start-development.md) (se liberada) |
...
- [ ] [`init-project`](01-init-project.md) — identidade.
- [ ] [`discover-business`](02-discover-business.md) — mercado + valor.
- [ ] [`design-business-model`](06-design-business-model.md) — planos e GTM.
- [ ] [`define-product`](03-define-product.md) — MVP definido.
- [ ] [`plan-modules`](09-plan-modules.md) — módulos identificados.
- [ ] [`choose-stack`](07-choose-stack.md) — stack escolhida com ADR.
- [ ] [`design-architecture`](08-design-architecture.md) — arquitetura, segurança, observabilidade, deploy.
- [ ] [`define-module-spec`](10-define-module-spec.md) — pelo menos do **primeiro módulo a implementar**.
- [ ] [`create-implementation-plan`](12-create-implementation-plan.md) — para o mesmo módulo.
...
- Se aprovado: [`start-development`](14-start-development.md).
...
🚫 **Aprovação com premissa A-XXXX (confiança 1, impacto fatal) aberta.** Recusar — invoque [`validate-idea`](04-validate-idea.md) antes.
...
➡️ **[`start-development`](14-start-development.md)** — começar a codar pelo primeiro módulo.
