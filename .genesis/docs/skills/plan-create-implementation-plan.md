...
| Skill anterior | [`define-module-spec`](plan-define-module-spec.md) |
| Skill seguinte | [`start-development`](dev-start-development.md) |
...
O resultado: `docs/specs/<modulo>/implementation-plan.md` — entrada direta para [`start-development`](dev-start-development.md).
...
- Após [`define-module-spec`](plan-define-module-spec.md) aprovar a spec de um módulo.
- Antes de [`start-development`](dev-start-development.md) para esse módulo.
...
E sugere próxima skill: [`start-development`](dev-start-development.md).
...
➡️ **[`start-development`](dev-start-development.md)** — executar o plano, tarefa a tarefa, com TDD.
...
- Agents relevantes:
  - [`implementation-planner`](../../../.claude/agents/plan-implementation-planner.md) — para revisar decomposição.
  - [`software-architect`](../../../.claude/agents/plan-software-architect.md) — para checar acoplamentos cruzados.
