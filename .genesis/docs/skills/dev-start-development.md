...
| Skill anterior | [`review-readiness`](plan-review-readiness.md) |
...
- **Apenas** após [`review-readiness`](plan-review-readiness.md) ter retornado **aprovado**.
...
- [ ] [`review-readiness`](plan-review-readiness.md) → **APROVADO** (registrado em `PROJECT_STATE.md`).
- [ ] [`docs/specs/<modulo>/`](../../../docs/specs/) completo (overview, data-model, api, events, business-rules, acceptance).
- [ ] [`docs/specs/<modulo>/implementation-plan.md`](../../../docs/specs/) criado por [`create-implementation-plan`](plan-create-implementation-plan.md).
...
Se exit code ≠ 0, **aborta**. Volta para [`review-readiness`](plan-review-readiness.md).
...
- Se uma decisão importante surgiu, criar ADR via [`create-adr`](plan-create-adr.md).
...
- Invoque [`define-module-spec`](plan-define-module-spec.md) para o próximo módulo da ordem.
...
➡️ **Loop:** terminada a primeira tarefa → próxima tarefa. Terminado o primeiro módulo → invoque [`define-module-spec`](plan-define-module-spec.md) para o próximo módulo da ordem.

➡️ **Em paralelo:** sempre que decisão importante surgir → [`create-adr`](plan-create-adr.md).
...
- Agents relevantes:
  - [`implementation-planner`](../../../.claude/agents/plan-implementation-planner.md) — para revisão de plano e decomposição.
  - [`software-architect`](../../../.claude/agents/plan-software-architect.md) — para decisões emergentes.
