...
| Skill seguinte | [`discover-business`](disc-discover-business.md) |
...
- [ ] **Não há documentação já preenchida** em `docs/product/` — se há, você provavelmente está em outra fase; use [`review-readiness`](plan-review-readiness.md) primeiro.
...
- [ ] A IA sugeriu explicitamente rodar [`discover-business`](disc-discover-business.md).
...
➡️ **[`discover-business`](disc-discover-business.md)** — entender público, mercado, valor e monetização inicial.
...
- Agents relevantes:
  - [`product-strategist`](../../../.claude/agents/plan-product-strategist.md) — pode revisar a visão quando preencher.
  - [`ux-researcher`](../../../.claude/agents/plan-ux-researcher.md) — pode revisar quem é a persona.
