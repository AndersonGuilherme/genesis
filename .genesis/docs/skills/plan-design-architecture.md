...
| Skill anterior | [`choose-stack`](plan-choose-stack.md) |
| Skill seguinte | [`define-module-spec`](plan-define-module-spec.md) |
...
- Após [`choose-stack`](plan-choose-stack.md) com ADR-0001 criado.
- Antes de [`define-module-spec`](plan-define-module-spec.md).
...
- [ ] (Recomendado) [`plan-map-users.md`](plan-map-users.md) já invocado para definir papéis.
...
Invoque [`create-adr`](plan-create-adr.md) para cada.

### 13. Atualize `PROJECT_STATE.md`

Marca Fase 7 ✅ e sugere [`define-module-spec`](plan-define-module-spec.md).
...
| ADRs (mín. 3) | Banco, padrão arquitetural, auth, multi-tenancy. | Via [`create-adr`](plan-create-adr.md). |
...
➡️ **[`define-module-spec`](plan-define-module-spec.md)** — para cada módulo crítico, escrever spec completa.
...
- Agents relevantes:
  - [`software-architect`](../../../.claude/agents/plan-software-architect.md) — revisão geral.
  - [`security-reviewer`](../../../.claude/agents/plan-security-reviewer.md) — para auth/PII/LGPD.
  - [`scalability-reviewer`](../../../.claude/agents/plan-scalability-reviewer.md) — para SLO/cache/fila.
