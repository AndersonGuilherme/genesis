...
5. **Rode `.genesis/scripts/check-readiness.sh`** sempre que quiser saber se já pode começar a implementar.
...
O exemplo serve como inspiração, **não como template fixo**. Apague o diretório `.genesis/examples/` antes de usar este boilerplate de verdade.
