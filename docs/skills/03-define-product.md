...
| Skill anterior | [`design-business-model`](06-design-business-model.md) ou [`discover-business`](02-discover-business.md) |
| Skill seguinte | [`plan-modules`](09-plan-modules.md) (ou [`validate-idea`](04-validate-idea.md) se premissas fatais ainda abertas) |
...
- Após [`discover-business`](02-discover-business.md) (ou [`design-business-model`](06-design-business-model.md)) ter te dado clareza de público e monetização.
...
- Antes de [`plan-modules`](09-plan-modules.md) — não dá pra modular um produto que ainda não tem MVP definido.
...
A IA marca Fase 4 como concluída e sugere [`plan-modules`](09-plan-modules.md) (ou [`validate-idea`](04-validate-idea.md) se premissas fatais).
...
Antes de avançar para `plan-modules`, invoque [`validate-idea`](04-validate-idea.md). Construir baseado em achismo crítico é caro.

## Próximo passo

➡️ **[`plan-modules`](09-plan-modules.md)** — quebrar o MVP em módulos.

ou (se premissas fatais ainda abertas):

➡️ **[`validate-idea`](04-validate-idea.md)** — validar antes de construir.
