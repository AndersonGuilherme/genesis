...
| Skill anterior | [`design-architecture`](08-design-architecture.md) |
| Skill seguinte | [`create-implementation-plan`](12-create-implementation-plan.md) |
...
A skill é invocada **uma vez por módulo crítico do MVP**. Você roda ela, gera spec, depois pode rodar [`create-implementation-plan`](12-create-implementation-plan.md) e finalmente codar. Repete o ciclo para o próximo módulo.
...
- Após [`design-architecture`](08-design-architecture.md) concluir a visão geral.
...
Marca módulo como "spec pronta". Sugere [`create-implementation-plan`](12-create-implementation-plan.md) para esse módulo.
...
➡️ **[`create-implementation-plan`](12-create-implementation-plan.md)** — quebrar essa spec em tarefas verticais XS-M para implementação TDD.
