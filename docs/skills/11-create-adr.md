...
- Após [`choose-stack`](07-choose-stack.md) — ADR-0001 da stack principal.
- Durante [`design-architecture`](08-design-architecture.md) — ADRs estruturais (banco, padrão arquitetural, auth, multi-tenancy).
- Após [`design-business-model`](06-design-business-model.md) — ADR do modelo de receita.
- Durante [`define-module-spec`](10-define-module-spec.md) — ADR de decisões específicas do módulo.
